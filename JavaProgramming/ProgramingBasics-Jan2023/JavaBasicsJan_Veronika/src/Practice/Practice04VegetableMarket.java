...
public class Practice04VegetableMarket {
    public static void main(String[] args) {
        ...
        double vegiPriceKg = Double.parseDouble(scanner.nextLine());
        double fruitPriceKg = Double.parseDouble(scanner.nextLine());
        int vegiSumKG = Integer.parseInt(scanner.nextLine());
        int fruitSumKg = Integer.parseInt(scanner.nextLine());

        double totalPriceEuro = ((vegiPriceKg*vegiSumKG) + (fruitPriceKg*fruitSumKg)) / 1.94;
